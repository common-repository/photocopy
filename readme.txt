...
This plugin is discontinued. To the best of my knowledge it is stable and works fine, but since it's release I have decided it is <a href="http://wptavern.com/ryan-hellyers-aws-nightmare-leaked-access-keys-result-in-a-6000-bill-overnight">no longer advisable</a> to store Amazon credentials in PHP files.
...
For more information, visit the <a href="https://geek.hellyer.kiwi/products/photocopy/">Photocopy plugin page</a>.
